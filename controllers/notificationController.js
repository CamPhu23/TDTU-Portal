...
exports.getNotificationList = (req, res) => {
    ...
    .exec(function(err, noti) {
        ...
        res.render('pages/notification', {notiList: noti, link: detail_href, date: detail_date, pagi, pagi_link, isAdded, permissionNoti: permission})
    })
}
...
exports.getNotificationDetails = (req, res) => {
    ...
    .then((noti) => {
        ...
        res.render('pages/detailsNotification', {noti, date, delete_href, isEditable, permissionNoti: permission})
    })
